...
public class DadosAcademia {
    ...
    public static List<Modalidade> carregarModalidadesInfantil() {
        ...
        Modalidade jiuJitsu = new Modalidade("Jiu Jitsu", "Foco em luta de chão.", Arrays.asList(jiuJitsuCriancas));

        return Arrays.asList(karate, ginastica, taekwondo, jiuJitsu);
    }
